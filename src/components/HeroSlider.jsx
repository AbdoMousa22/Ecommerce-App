         ...
         <div className="container">
            <Swiper loop={true}  autoplay={{ delay: 2500, disableOnInteraction: false }} pagination={true} modules={[Pagination , Autoplay]} className="mySwiper">
                <SwiperSlide>
                    ...
                    <img src="././public/img/banner_Hero1.jpg" alt="slider hero 1" />
                </SwiperSlide>
                <SwiperSlide>
                    <div className="content">
                        <h4>Introducing the new</h4>
                    ...
                    <img src="././public/img/banner_Hero2.jpg" alt="slider hero 2" />
                </SwiperSlide>
                <SwiperSlide>
                    <div className="content">
                        <h4>Introducing the new</h4>
                    ...
                    <img src="././public/img/banner_Hero3.jpg" alt="slider hero 3" />
                </SwiperSlide>
